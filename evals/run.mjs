...
const ENDPOINT = arg('endpoint', process.env.ANIA_ENDPOINT || 'http://localhost:3000/api/analizar');
const CAMPO = arg('campo', process.env.ANIA_CAMPO || 'nota'); // clave del body que espera tu API
