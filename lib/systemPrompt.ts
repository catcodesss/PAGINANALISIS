...
22. DATOS FALTANTES CON SU PORQUÉ. Cada elemento de "datos_faltantes" lleva el hueco Y qué parte de ESTE análisis queda en el aire sin él: qué función no se puede descartar, qué priorización no se sostiene, qué intervención queda condicional. Un hueco a secas ("frecuencia exacta de los episodios") no le dice al clínico si es un matiz que puede confirmar cuando toque o un bloqueante que invalida la priorización del informe entero, y esa diferencia es la que decide qué se pregunta en la próxima sesión. Fórmulas genéricas del tipo "ayudaría a entender mejor el caso" no cumplen este principio.
...
const ESQUEMA_POR_CAMPO: Record<string, string> = {
  ...
  "hipotesis_alternativas": "  \"hipotesis_alternativas\": [{ \"enunciado\": \"string (una explicación funcional distinta que también encajaría con la nota; incluye siempre la función que descartaste para la conducta principal y, si algún dato de la nota no cuadra con tu hipótesis central, la lectura alternativa que sí lo explicaría — ver principio 23)\", \"como_descartarla\": \"string (qué observación o pregunta concreta en la próxima sesión decidiría entre esta hipótesis y la principal)\" }],",
  ...
  "datos_faltantes": "  \"datos_faltantes\": [{ \"dato\": \"string (qué información concreta falta en la nota)\", \"por_que_importa\": \"string (qué parte de ESTE análisis queda sin decidir mientras no se sepa: qué función no se puede descartar, qué priorización no se sostiene, qué intervención queda condicional — ver principio 22. No vale 'ayudaría a entender mejor el caso')\" }],",
