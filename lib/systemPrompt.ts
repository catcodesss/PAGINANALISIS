...
- NOMBRA LOS DOS EXTREMOS. Una relación tiene dos puntas: el campo "conducta" nombra una y "origen" nombra la otra con las mismas palabras que ya usaste al describirla — la variable moduladora concreta de "variables_moduladoras", o la otra conducta de "conductas_problema". No basta con una categoría abstracta ("malestar condicionado"): escribe la entidad concreta. El servidor resuelve ambos textos a ids y la prosa se deriva después de las relaciones efectivamente trazadas.
