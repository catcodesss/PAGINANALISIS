...
const ESQUEMA_POR_CAMPO: Record<string, string> = {
  ...
  "variables_moduladoras": "  \"variables_moduladoras\": [{ \"tipo\": \"biologica | historia_de_aprendizaje | contextual\", \"descripcion\": \"string\", \"modificabilidad\": \"alta | media | baja (cuánto puede CAMBIAR esto con intervención, NO cuánto importa — ver principio 29)\", \"evidencia\": { \"linea_inicio\": number, \"linea_fin\": number } o null }],",
