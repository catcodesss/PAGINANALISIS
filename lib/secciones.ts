...
export const ANCLAS_INFORME = [
  ...
  { id: "conductas-alternativas", titulo: "Plan por blanco", bloque: "plan" },
  { id: "intervencion", titulo: "Líneas de intervención sin asignar", bloque: "plan" },
  { id: "monitorizacion", titulo: "Monitorización del caso", bloque: "plan" },
